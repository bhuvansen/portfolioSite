...
export const Projects = () => {
  const projects = [
    {
      title: "A6 Modernization",
      description: "TCS Client Project",
      imgUrl: projImg1,
    },
    {
      title: "Portfolio Website",
      description: "Own Portfolio Site",
      imgUrl: projImg1,
    },
    {
      title: "Currency Formatter Library",
      description: "Library to automatically format values entered with $/CAD/RS based on groups",
      imgUrl: projImg1,
    },
  ]
